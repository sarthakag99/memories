...
const Home = () => {
    ...
    // useEffect(() => {
    //     dispatch(getPosts());
    // }, [currentId, dispatch]); // (refreshError) - my code is still automatically changing if not used currentId but youtube person's not changing so he added currentId so as I. 
