...
const Form = ({ currentId, setCurrentId }) => {
    ...
    const post = useSelector((state) => currentId ? state.posts.find((p) => p._id === currentId) : null); //this state.posts is from index.js of reducers from ending (posts:posts) part 
